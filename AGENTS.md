use latest go features and syntax
search for latest go features and syntax to implement the CLI and project foundation as outlined in the milestones document. Focus on using modern Go practices, such as context handling, error wrapping, and structured logging.
search internet to verify your implementation and align code with latest code practices and standards in the Go community.
